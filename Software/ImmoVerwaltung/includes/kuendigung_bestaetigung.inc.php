    ...
    foreach( $_POST['empfaenger'] as $value) {
        ...
        if(!mysqli_stmt_prepare($stmt, $sql)){
            ...
            if($row=mysqli_fetch_assoc($result)){
                ...
                $pdf->Cell(14);
                $pdf->Cell(10,10,"Ihre K�ndigung des Mietverh�tnisses zum $datum_nutzungsende",0,0);
                $pdf->Ln(20);
                $pdf->SetFont("times","",9);
                $pdf->Cell(14);
                ...
                $pdf->Ln(12);
                $pdf->Cell(14);
                $pdf->MultiCell(0,4,"hiermit best�tige ich Ihre K�ndigung des Wohnraummietvertrages der Wohnung in $empfaenger_strasse $empfaenger_hausnr, $empfaenger_plz $empfaenger_ort vom $datum_kuendigung fristgerecht zum $datum_nutzungsende.", 0,"L",false);
                $pdf->Ln(4);
                $pdf->Cell(14);
                $pdf->MultiCell(0,4,"Ich bitte Sie sich nach dem Auszug zu melden, damit bei einer Begehung ein abschlie�endes �bergabeprotokoll erstellt und die Schl�ssel�bergabe geregelt werden kann.", 0,"L",false);
                $pdf->Ln(12);
                $pdf->Cell(14);
                $pdf->Cell(10,10,"Mit freundlichen Gr��en,",0,0);
                $pdf->Ln(4);
                $pdf->Cell(14);
